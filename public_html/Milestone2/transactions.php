...
function do_bank_action($account1, $account2){
	require("config.php");
	...
	VALUES(:p1a1, :p1a2, :p1change), 
			(:p2a1, :p2a2, :p2change,:a2total)";
...
<?php
if(isset && isset($_POST['account1']) && isset($_POST['amount'])){
	$amount = (int)$_POST['amount'];
{
		case 'deposit':
			do_bank_action("000000000000", $_POST['account1'], ($amount * -1));
			break;
		case 'withdraw':
			do_bank_action($_POST['account1'], "000000000000", ($amount * -1));
			break;
		case 'transfer':
			//TODO figure it out
			break;
